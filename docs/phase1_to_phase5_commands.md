# slam_system_manager Phase 1-5 功能与命令手册（截至 Phase 5）
...
用途：执行状态机、ProcessManager、MapManager 和 MappingAdapter 的全部单元测试。
...
当前尚未实现 Localization 控制、初始位姿和 Last Pose，这些属于 Phase 6 和 Phase 7。
